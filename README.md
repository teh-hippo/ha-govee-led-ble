...
| **H6179** | Experimental | Power, raw brightness, RGB, colour temperature, 83 scenes, two device-microphone music modes and Effect Studio single/mixed DIY using an explicitly approved disposable slot |
