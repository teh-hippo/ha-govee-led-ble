...
| **H6125** | Experimental | Power on recognised hardware families and experimental raw-register brightness on hardware family 1; RGB, colour temperature, segments, scenes, music and custom effects remain disabled; the full model catalogue remains packaged only as inert protocol data | [#117](https://github.com/teh-hippo/ha-govee-led-ble/issues/117) |
