...
class StatusQuery(ReadWriteKaitaiStruct):
    ...
    def __init__(self, _io=None, _parent=None, _root=None):
        super(StatusQuery, self).__init__(_io)
    ...
    def _read(self):
        ...
        self.domain = KaitaiStream.resolve_enum(StatusQuery.QueryDomain, self._io.read_u1())
        _on = self.domain
        if _on == StatusQuery.QueryDomain.brightness:
            pass
            self._raw_body = self._io.read_bytes(17)
            _io__raw_body = KaitaiStream(BytesIO(self._raw_body))
            self.body = StatusQuery.ZeroBody(_io__raw_body, self, self._root)
            self.body._read()
        elif _on == StatusQuery.QueryDomain.colour_mode:
            pass
            self._raw_body = self._io.read_bytes(17)
            _io__raw_body = KaitaiStream(BytesIO(self._raw_body))
            self.body = StatusQuery.ZeroBody(_io__raw_body, self, self._root)
            self.body._read()
        elif _on == StatusQuery.QueryDomain.firmware:
            pass
            self._raw_body = self._io.read_bytes(17)
            _io__raw_body = KaitaiStream(BytesIO(self._raw_body))
            self.body = StatusQuery.ZeroBody(_io__raw_body, self, self._root)
            self.body._read()
        elif _on == StatusQuery.QueryDomain.hardware:
            pass
            self._raw_body = self._io.read_bytes(17)
            _io__raw_body = KaitaiStream(BytesIO(self._raw_body))
            self.body = StatusQuery.HardwareQueryBody(_io__raw_body, self, self._root)
            self.body._read()
        elif _on == StatusQuery.QueryDomain.power:
            pass
            self._raw_body = self._io.read_bytes(17)
            _io__raw_body = KaitaiStream(BytesIO(self._raw_body))
            self.body = StatusQuery.ZeroBody(_io__raw_body, self, self._root)
    ...
    def _write__seq(self, io=None):
        super(StatusQuery, self)._write__seq(io)
    ...
    class HardwareQueryBody(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(StatusQuery.HardwareQueryBody, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(StatusQuery.HardwareQueryBody, self)._write__seq(io)
    ...
    class ZeroBody(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(StatusQuery.ZeroBody, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(StatusQuery.ZeroBody, self)._write__seq(io)
            for i in range(len(self.zeros)):
                pass
                if self._io.is_eof():
                    raise kaitaistruct.ConsistencyError(u"zeros", 0, self._io.size() - self._io.pos())
