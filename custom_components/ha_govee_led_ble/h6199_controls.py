...
# Numbers, in the order they are added. Video percentages ride their mode's frame; relative
# brightness owns a register and white balance is added as a dedicated slider.
...
async def async_setup_number_entry(
    ...
    entities: list[NumberEntity] = [
        ...
        if NUMBER_CONTROLS[key].supports(coordinator.profile)
    ]
