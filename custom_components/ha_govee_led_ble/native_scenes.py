...
from .generated_protocol_adapter import build_camera_scene, build_h617a_scene
...
def build_native_scene_packets(
    ...
    *,
    ...
    if resolved == "H617A":
        activation = build_h617a_scene(scene.code)
    elif resolved is not None:
        activation = build_camera_scene(model, scene.code, scene.music_code)
    else:
