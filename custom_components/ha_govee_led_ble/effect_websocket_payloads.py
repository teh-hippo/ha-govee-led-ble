...
def item_summary(item: LibraryItem) -> dict[str, Any]:
    ...
    if model in {"H617A", "H617E", "H6099", "H6199"}:
        summary["model"] = model
        ...
        if isinstance(template, dict) and template.get("sku") in {"H617A", "H617E", "H6099", "H6199"}:
            summary["model"] = template["sku"]
    elif item.target_hint is not None and item.target_hint.model in {"H617A", "H617E", "H6099", "H6199"}:
