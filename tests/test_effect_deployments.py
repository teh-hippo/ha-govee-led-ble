...
def test_deployment_round_trip_preserves_prior_state_and_verification_confidence() -> None:
    prior_state = PriorControlState(
        ...
        segment_colors=((1, 2, 3), (4, 5, 6)),
        segment_brightness=(25, 75),
        effect="forest",
        scene_code=2163,
        diy_code=800,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"music_separation_point": -1}, "prior separation point must be from 0 to 255"),
        ...
        ({"segment_colors": ((1, 2, 3),)}, "must be stored together"),
