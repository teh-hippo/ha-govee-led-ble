...
async def test_surfaces_segment_fields(mock_h6199_coordinator):
    ...
    assert coord["supports_segment_colour_writes"] is True
    assert coord["supports_segment_brightness_writes"] is True
...
async def test_h6076_diagnostics_expose_basic_capability_boundary(mock_h6076_coordinator):
    ...
    assert coord["supports_segment_colour_writes"] is False
    assert coord["supports_segment_brightness_writes"] is False
