...
- the BLE local-name prefix with its unique suffix removed, for example `Govee_H6076_...`;
...
3. An immutable exact-SHA prerelease is published with a model suffix such as `.h6076`.
